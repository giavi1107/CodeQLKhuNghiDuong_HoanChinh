...
//    private ArrayList <QuanLy> listChi =new ArrayList<>();
    ...
    private ArrayList <DatPhong> listDatPhong =new ArrayList<>();
    private ArrayList <DichVu> listDichVu =new ArrayList<>();
    private ArrayList <QuanLy> listGiayPhep =new ArrayList<>();
    private ArrayList <Thu> listThu =new ArrayList<>();
    private ArrayList <Chi> listChi =new ArrayList<>();
    ...
    private void showDatPhong()
    {
        ...
        System.out.println(label);
        for (DatPhong quanLy : listDatPhong) {
            System.out.println(quanLy.toString());
        }
    ...
    private void showPhongTrong()
    {
        ...
        for (DatPhong datPhong : listDatPhong) {
            if(datPhong.getTrangThaiPhong()==TrangThaiPhong.Trong){
    ...
    private void update_phongTrong(int id)
    {
        ...
        for(DatPhong dp:listDatPhong)
        {
            if(dp.getId()==id)
            {
                if(dp.getTrangThaiPhong()==TrangThaiPhong.Co_Khach_O)
                {
                    dp.setTrangThaiPhong(TrangThaiPhong.Trong);
                }
...
//    }
    ...
    private void xoaKhachHang(int id) {
    Iterator<KhachHang> iterator = listKhachHang.iterator();
    while (iterator.hasNext()) {
        KhachHang kh = iterator.next();
        if (kh.getId() == id) {
            iterator.remove();
            break; // Nếu chỉ có một phần tử trùng khớp thì có thể dùng break để kết thúc lặp
        }
    }
     ...
     private void subMenu(int choice)
     {
        ...
        else if (choice ==2)
        {
            ...
            System.out.println("4. Hiển thị danh sách phòng trống");
